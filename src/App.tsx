    ...
    <div className="min-h-screen selection:bg-brand-accent/30">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass h-16 flex items-center justify-between px-6 md:px-12">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <button className="bg-brand-text text-white px-6 py-2 rounded-button hover:bg-brand-text/90 transition-all">
            Get Started
          </button>
        </div>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <button className="bg-brand-accent text-white py-4 rounded-xl mt-4">
            Get Started
          </button>
        </motion.div>
      )}
      ...
      <main>
        ...
        <section className="pt-32 pb-20 px-6 md:px-12 lg:px-24 flex flex-col items-center text-center">
          ...
          >
            <motion.span 
              variants={fadeIn}
              className="inline-block px-4 py-1.5 bg-brand-accent/10 text-brand-accent rounded-full text-xs font-semibold tracking-wider uppercase mb-6"
            >
              Soul over Scroll
            </motion.span>
            <motion.h1 
            ...
            >
              Replace mindless scrolling with <span className="italic text-brand-accent">micro-wins.</span>
            </motion.h1>
            <motion.p 
              variants={fadeIn}
              className="text-lg md:text-xl text-brand-muted mb-10 max-w-2xl mx-auto font-sans leading-relaxed"
            >
            ...
            >
              <button className="w-full sm:w-auto bg-brand-accent text-white px-8 py-4 rounded-button text-lg font-medium hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 group">
                Start My First Challenge
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="w-full sm:w-auto px-8 py-4 rounded-button text-lg font-medium border border-brand-border hover:bg-white transition-all">
                See How It Works
              </button>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-full max-w-md p-8 glass rounded-card shadow-xl">
                <div className="flex items-center justify-between mb-6">
                  <span className="text-xs font-semibold text-brand-muted uppercase tracking-widest">Current Quest</span>
                  <span className="text-brand-accent font-mono text-sm">00:54</span>
                </div>
                <h3 className="text-2xl mb-2">Sketch your morning coffee</h3>
                <p className="text-brand-muted text-sm mb-6">A quick creative burst to reset your focus. No perfection required.</p>
                <div className="w-full h-2 bg-brand-border rounded-full overflow-hidden mb-8">
                  <div className="w-1/3 h-full bg-brand-accent" />
                </div>
                <button className="w-full py-3 bg-brand-text text-white rounded-lg font-medium">Complete Challenge</button>
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section id="how" className="section-padding bg-white">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl mb-6">The attention economy is winning. <br/><span className="text-brand-muted">It's time to fight back.</span></h2>
        ...
        <section className="section-padding">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
            {[
              { 
                pain: "The Doomscroll", 
                solution: "The Micro-Quest", 
                desc: "Swap 30 minutes of noise for 60 seconds of focused learning.",
                icon: <Clock className="w-6 h-6" />
              },
              { 
                pain: "Digital Guilt", 
                solution: "Real Progress", 
                desc: "End your day feeling accomplished instead of drained.",
                icon: <CheckCircle2 className="w-6 h-6" />
              },
              { 
                pain: "High Friction", 
                solution: "One-Tap Entry", 
                desc: "No 'monk mode' required. Just a better choice at the right time.",
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { title: "60-Second Quests", desc: "Curated micro-lessons in languages, art, coding, and mindfulness.", icon: <Sparkles /> },
                ...
                <motion.div 
                  key={i}
                  whileHover={{ y: -5 }}
                  className="p-8 border border-white/10 rounded-card bg-white/5 hover:bg-white/10 transition-all"
                >
        ...
        <section className="section-padding">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
              {[
                { 
                  quote: "I swapped my 2am TikTok habit for 2am Spanish lessons. I actually feel awake and energized now instead of drained.",
                  author: "Sarah J.",
                  role: "Product Designer"
                },
                { 
                  quote: "Rewire didn't take away my phone; it just made my phone work for me. The 60-second quests are the perfect length.",
                  author: "Mark T.",
                ...
                <div key={i} className="p-8 bg-white border border-brand-border rounded-card relative">
                  ...
                  <p className="text-lg mb-8 italic leading-relaxed">"{t.quote}"</p>
        ...
        <section id="pricing" className="section-padding bg-white">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`p-8 rounded-card border ${plan.recommended ? 'border-brand-accent bg-brand-accent/5 ring-4 ring-brand-accent/5' : 'border-brand-border bg-brand-bg'} flex flex-col`}>
        ...
        <section className="section-padding bg-brand-accent text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto bg-white text-brand-accent px-10 py-5 rounded-button text-xl font-bold hover:scale-105 transition-all">
                Get Started Now
              </button>
              <button className="w-full sm:w-auto px-10 py-5 rounded-button text-xl font-bold border border-white/30 hover:bg-white/10 transition-all">
                View Demo
              </button>
            </div>
      ...
      <footer className="py-12 px-6 md:px-12 lg:px-24 border-t border-brand-border bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="text-xs text-brand-muted">
            © 2026 Rewire Inc. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
